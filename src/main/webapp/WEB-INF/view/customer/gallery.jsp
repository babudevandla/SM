...
<jsp:body>
	...
	<div class="create-post">
       ...
       <div class="media">
                ...
                <div class="grid-item col-md-5 col-sm-5">
            			<div class="media-grid">
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-1">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/3.mp4" type="video/mp4">
                      </video>
                    </div>
                ...
                <div class="grid-item col-md-5 col-sm-5">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-2">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/2.mp4" type="video/mp4">
                      </video>
                    </div>
                   <!--  <div class="media-info">
                      <div class="reaction">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-3">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/4.mp4" type="video/mp4">
                      </video>
                    </div>
                    <!-- <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-5 col-sm-5">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-4">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/5.mp4" type="video/mp4">
                      </video>
                    </div>
                    <!-- <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-5 col-sm-5">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-5">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/6.mp4" type="video/mp4">
                      </video>
                    </div>
                    <!-- <div class="media-info">
                      <div class="reaction">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-6">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/1.mp4" type="video/mp4">
                      </video>
                    </div>
                    <!-- <div class="media-info">
                      <div class="reaction">
                ...
                <div class="grid-item col-md-5 col-sm-5">
                    ...
                    <div class="img-wrapper" data-toggle="modal" data-target=".modal-7">
                      <video controls>
                        <source src="${contextPath}/resources/default/videos/7.mp4" type="video/mp4">
                      </video>
                    </div>
                    <!-- <div class="media-info">
                      <div class="reaction">
