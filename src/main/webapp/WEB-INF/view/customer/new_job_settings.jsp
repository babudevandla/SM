...
<jsp:attribute name="title">New Job Settings</jsp:attribute>
<jsp:body>
   
		<div class="col-md-7">
          <div class="edit-profile-container">
            <div class="block-title">
              <h4 class="grey"><i class="icon ion-android-checkmark-circle"></i>create new job settings</h4>
              <div class="line"></div>
              <p> please provide basic information for setting your own remainder job</p>
              <div class="line"></div>
            </div>
              ...
              <form name="basic-info" id="basic-info" class="form-inline">
                <div class="row">
                  <div class="form-group col-xs-6">
                    <label for="firstname">Remainder Name</label>
                    <input id="firstname" class="form-control input-group-lg" type="text" name="remainder_name"  />
                  </div>
                </div>
                <div class="row">
                ...
                <button class="btn btn-primary">Save new remainder</button>
              </form>
            </div>
          </div>
  </jsp:body>
